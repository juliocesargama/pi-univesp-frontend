    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                <h3 aria-label="Cadastro de novo item">Novo Item</h3>
            </div>
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <select v-model="model.item.status" class="form-select form-control" aria-describedby="seleção do status do item">
                        <option disabled value="">Selecione...</option>
                        <option v-for="(status, index) in itemStatus" :key="status" :value="index">{{
                            status }}</option>
                    </select>
                </div>
                <div class="float-end">
